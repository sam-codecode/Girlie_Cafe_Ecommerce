...
(1,'Meatless Breakie',
'A nourishing vegetarian breakfast designed to be both filling and comforting, featuring a sunny side up egg, flavourful plant-based meatless patty, sautéed mushrooms, creamy avocado, baked beans, and crispy toasted sourdough. Balanced in texture and taste, proving meatless can still be satisfying.',
20.00,35,'meatless_breakie.png'),

(1,'Eggs Your Way',
'A flexible brunch classic allowing you to choose between fluffy scrambled eggs or a perfectly cooked sunny side up egg. Served alongside your preferred bread, fresh mixed greens, and a beautifully caramelised brûléed orange that adds a light citrus sweetness to finish the dish.',
14.00,45,'eggs_your_way.png'),

(1,'Pesto Egg Toast',
'Soft, creamy scrambled eggs layered generously over pesto-coated sourdough toast, delivering bold herbal richness in every bite. Served with a juicy chicken sausage and fresh greens, this dish balances flavour, protein, and freshness beautifully.',
23.00,30,'pesto_egg_toast.png'),
